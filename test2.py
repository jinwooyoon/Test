...
for i in tqdm(Df_url[0:30]):
    ...
    test_list.append([spectator_grade,netizen_grade,images,reporter_grade,genre,country,runtime,release,director,actor,age,summary,man,woman,age_10,age_20,age_30,age_40,age_50])

test_list_df = pd.DataFrame(test_list,columns=['spectator','netizen','thumbnail','reporter','genre','country','rumtime','release','director','actor','age','summary','man','woman','age_10','age20','age30','age40','age50'])
